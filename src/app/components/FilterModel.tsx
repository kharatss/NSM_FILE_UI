...
const FilterModal = () => {
    ...
    return (
        <div>
            <FontAwesomeIcon icon={faFilter} className="text-gray-600 cursor-pointer" onClick={handleClick} />
                        ...
                        >
                            {({ errors, touched, isSubmitting, isValid }) => (
                                <Form>
                                    ...
                                    <div className="mb-4 px-5">
                                        <label htmlFor="dateFiled" className="block text-sm font-semibold text-gray-700">
                                            Date Filed
                                        </label>
                                        <Field
                                            type="date"
                                        ...
                                        {errors.dateFiled && touched.dateFiled && (
                                            <div className="text-red-500 text-sm mt-1">{errors.dateFiled}</div>
                                        )}
                                    </div>
